...
train_features = np.load('/home/sxg8458/RSNA_Bone_Age/train_images.npy')
print('The shape of the train features is %s ' %str(train_features.shape))


test_features = np.load('/home/sxg8458/RSNA_Bone_Age/test_images.npy')
...
with open('/home/sxg8458/RSNA_Bone_Age/output_resnet.txt', 'w') as f:
